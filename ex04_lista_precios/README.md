...
# Ejercicio 04 — Lista de precios (A/B/C; X=terminar) (GitHub Classroom + IA)

## Contexto (por qué importa)
Inventarios/ventas con claves de artículo.

## Enunciado del problema
Lee claves **A/B/C** y muestra su precio por línea. Al leer **X**, imprime el **total**.  
**Precios**: A=120, B=250, C=360
